...
namespace Project
{
    ...
    public class CharacterMotorConfig : ScriptableObject
    {
        ...
        public float Camera_HorizontalSensitivity = 100f;
        public float Camera_VerticalSensitivity = 100f;
        public float Camera_MinPitch = -75f;
        public float Camera_MaxPitch = 75f;
        public float Camera_InitialDiscardTime = 0.2f;
        ...
        [Range(0f, 1f)] public float MaximumFallDamagePercentage = 1f;

        [Header("Air Control")]
        public bool CanAirControl = true;
        [Range(0, 1)] public float AirControlMultiplier = 1f;
        ...
        [Header("Audio")]
        public float FootstepInterval_Walking = 2.5f;
        public float FootstepInterval_Running = 2f;
        public float MinAirTimeForLandedSound = 0.2f;

        [Header("Stamina")]
        public float MaxStamina = 100f;
        public float StaminaCost_Jumping = 20f;
        public float StaminaCost_Running = 7.5f;
