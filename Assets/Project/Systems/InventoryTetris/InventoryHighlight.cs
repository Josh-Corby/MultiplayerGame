...
public class InventoryHighlight : MonoBehaviour
{
    ...
    public void SetSize(InventoryItem item, float scaleFactor)
    {
        Vector2 size = new(
            item.Width * ItemGrid.TILE_SIZE_HEIGHT * scaleFactor,
            item.Height * ItemGrid.TILE_SIZE_HEIGHT * scaleFactor
            );
