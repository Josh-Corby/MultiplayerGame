    ...
    public class Nightmare : Enemy
    {
        ...
        private void Start()
        {
            ...
            else
            {
                ...
                At(wanderState, attackState, new FuncPredicate(() =>
                {
                    if (_playerDetector.CanDetectPlayer())
                    {
                        chaseState.UpdateTarget(_playerDetector.DetectedPlayer);
                        attackState.UpdateTarget(_playerDetector.DetectedPlayer);
                        return true;
                    }
                    return false;
                }));
