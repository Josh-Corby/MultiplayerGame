Fatty Sky - Cumulus. (2019/9/9 - by Fatty War, id3644@gmail.com)
...
Introduction
	...
	There are 4 types of sky (day, sunset, night, cloud).
	* Each sky is panorama type and box type.
	* Each sky is prepared with sun / sunless ( moon / moonless.)

1. File Location.
	1-1, Materials
		*SkyBox (Assets\FattySkybox_Cumulus\Materials\SkyBox)
			-Box type sky material is here.
			ex). FattySkyBox_Sunny = sunless, FattySkyBox_Sunny"S" = sun

		*SkyPanoramic (Assets\FattySkybox_Cumulus\Materials\SkyPanoramic)
			-Panorama type sky material is here.
			ex). FattySky_Sunny = sunless, FattySky_Sunny"S" = sun

	1-2, Textures
		*SkyBox (Assets\FattySkybox_Cumulus\Textures\SkyBox)
			...
			ex). FattySky_Sunny_01~06 = sunless, FattySky_Sunny"S"_01~06 = sun.

		*SkyPanoramic (Assets\FattySkybox_Cumulus\Textures\SkyPanoramic)
...
2.Sample Scene(FattySkyScene.unity)
	...
	* How to use the sample scene?
		a. Open sample scene. (Assets\FattySkybox_Cumulus\Scenes\FattySkyScene.unity)
